...
from GAN.errors import NotFittedError
from GAN.relational.hma import HMA1
from GAN.tabular.copulas import GaussianCopula
from GAN.utils import get_package_versions, throw_version_mismatch_warning
...
class GAN:
    ...
    Args:
        model (type):
            Class of the model to use. Defaults to ``relational.HMA1``.
        model_kwargs (dict):
    ...
    def fit(self, metadata, tables=None, root_path=None):
        """Fit this instance to the dataset data.
